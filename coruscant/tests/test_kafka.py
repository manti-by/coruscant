...
class TestKafka:
    @mock.patch("coruscant.services.kafka.producer")
    @mock.patch("coruscant.services.kafka.logger")
    def test_send_message__success(self, mock_logger, mock_producer):
    ...
    @mock.patch("coruscant.services.kafka.producer")
    @mock.patch("coruscant.services.kafka.logger")
    def test_send_message__kafka_error(self, mock_logger, mock_producer):
    ...
    @mock.patch("coruscant.services.kafka.producer")
    @mock.patch("coruscant.services.kafka.logger")
    def test_send_message__unexpected_error(self, mock_logger, mock_producer):
    ...
    @mock.patch("coruscant.services.kafka.producer")
    @mock.patch("coruscant.services.kafka.logger")
    def test_send_message__without_key(self, mock_logger, mock_producer):
        mock_future = mock.Mock()
        mock_record_metadata = mock.Mock()
        mock_record_metadata.topic = "odin"
